...
# Twilio Configuration - with default values to prevent import errors
...
def twilio_status_callback_simple(request):
    """
    Handle call status updates with intelligent auto-scheduling
    ...
    try:
        ...
        if call_status == 'completed':
            ...
            # 🧠 INTELLIGENT AUTO-SCHEDULING: Analyze call and schedule next one
            ...
            try:
                ...
                if scheduling_result['success']:
                    print(f"✅ Auto-scheduled next call for {call.to_number}: {scheduling_result['analyzed_outcome']}")
                else:
                    print(f"❌ Failed to auto-schedule: {scheduling_result.get('error')}")
                    
            except Exception as e:
                print(f"❌ Intelligent scheduling error: {str(e)}")
