...
class BaseAgent(models.Model):
    ...
    hume_config_id = models.CharField(
        max_length=200,
        blank=True,
        null=True,
        help_text="HumeAI EVI Config ID (auto-populated when agent is created)"
    )
...
# Auto Call Campaign Models
class AutoCallCampaign(models.Model):
    """Auto Call Campaign model for scheduled outbound calls"""
    ...
    name = models.CharField(max_length=200)
    campaign_type = models.CharField(max_length=20, choices=CAMPAIGN_TYPES, default='sales')
    ...
    working_hours_start = models.CharField(max_length=5, default='09:00')  # HH:MM
    working_hours_end = models.CharField(max_length=5, default='17:00')    # HH:MM
    
    # Campaign data
    campaign_data = models.JSONField(default=dict, blank=True)
...
class AutoCampaignContact(models.Model):
    """Individual contact in an auto call campaign"""
