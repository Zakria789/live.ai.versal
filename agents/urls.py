...
urlpatterns = [
    ...
    # 10. AUTO-CALL SCHEDULING SYSTEM - NEW!
    path('auto-calls/', views.AutoCallCampaignAPIView.as_view(), name='auto-calls'),                    # POST /agents/auto-calls/
    path('auto-calls/<uuid:campaign_id>/', views.AutoCallCampaignAPIView.as_view(), name='auto-calls-detail'),  # PUT/DELETE /agents/auto-calls/{campaign_id}/
    
    # 11. CAMPAIGN SCHEDULE MANAGEMENT - NEW!
    path('schedule/', views.CampaignScheduleAPIView.as_view(), name='campaign-schedule'),              # GET /agents/schedule/
    path('schedule/<uuid:campaign_id>/', views.CampaignScheduleAPIView.as_view(), name='campaign-schedule-detail'),  # GET /agents/schedule/{campaign_id}/
    path('schedule/control/', views.CampaignScheduleAPIView.as_view(), name='schedule-control'),       # POST /agents/schedule/control/
    
    # 12. REAL-TIME AUTO-SCHEDULER - NEW!
    path('auto-scheduler/', views.RealTimeAutoScheduler.as_view(), name='auto-scheduler'),             # POST /agents/auto-scheduler/
    
    # 13. INTELLIGENT CALL COMPLETION - NEW!
    path('complete-call/', views.AutoCallCampaignAPIView.as_view(), name='complete-call'),             # POST /agents/complete-call/
    
    # 14. INTELLIGENT SCHEDULING RULES - NEW!
    path('scheduling-rules/', views.IntelligentSchedulingRulesAPIView.as_view(), name='scheduling-rules'),        # GET/PUT /agents/scheduling-rules/
    path('call-outcome-stats/', views.CallOutcomeStatsAPIView.as_view(), name='call-outcome-stats'),             # GET /agents/call-outcome-stats/
    path('test-intelligent-scheduling/', views.TestIntelligentSchedulingAPIView.as_view(), name='test-scheduling'), # POST /agents/test-intelligent-scheduling/
]